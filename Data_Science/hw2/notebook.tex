...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Using version already downloaded: Fri Sep 14 07:15:15 2018
...
many possible solutions.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{holiday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} 0    16879
        1      500
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Modify holiday weekday, workingday, and weathersit here}
        ...
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{weekday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mon}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fri}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} 
                                \PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{holiday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{no}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{workingday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{no}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{weathersit}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Clear}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mist}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Light}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Heavy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} 
                                   \PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}
...
\texttt{num\_holidays} to this value.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{num\PYZus{}holidays} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{holiday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{daily\PYZus{}counts} \PY{o}{=} \PY{n}{bike}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{dteday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{agg}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sum}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sum}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} 
                                              \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{workingday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{first}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
\end{Verbatim}
...
anywher from almost none to 7000.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{ax} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{distplot}\PY{p}{(}\PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{sns}\PY{o}{.}\PY{n}{distplot}\PY{p}{(}\PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{green}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution Comparison of Casual vs Registered Riders}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Density}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rider Count}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} <matplotlib.legend.Legend at 0x7fbc74691e10>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{q2b} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{For the density curves for casual riders, the mode is around 0. It is asymmetry and right }
         \PY{l+s+s2}{skew. It has no left tail and relatively long right tail. It has some gaps round 2000 and }
         \PY{l+s+s2}{some outliers around 4000.}
         
         \PY{l+s+s2}{For the density curves for registered riders, the mode is around 4000. It is almost symmetry}
         \PY{l+s+s2}{and has no remarkable skewness. It has almost equally long tails on both sides. It has some }
         \PY{l+s+s2}{gaps around 3000 and 5000 but it is not very obvious. And it doesn}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{t have remarkable outliers.}
...
For the density curves for casual riders, the mode is around 0. It is asymmetry and right 
skew. It has no left tail and relatively long right tail. It has some gaps round 2000 and 
some outliers around 4000.

For the density curves for registered riders, the mode is around 4000. It is almost symmetry
and has no remarkable skewness. It has almost equally long tails on both sides. It has some 
gaps around 3000 and 5000 but it is not very obvious. And it doesn't have remarkable outliers.
...
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} Make the font size a bit bigger}
         ...
         \PY{n}{ax} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lmplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{hue}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{height} \PY{o}{=} \PY{l+m+mi}{8}\PY{p}{,}
                    \PY{n}{scatter\PYZus{}kws}\PY{o}{=}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{l+m+mi}{10}\PY{p}{\PYZcb{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{bike}\PY{p}{)}\PY{p}{;}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}17}]:} Text(0.5,1,'Comparison of Casual vs Registered Riders on Working and Non-working Days')
\end{Verbatim}
...
\href{http://www.textbook.ds100.org/ch/06/viz_principles_2.html}{textbook}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{q2d} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{The relationship between casual and registered riders is likely to be positively related. }
         \PY{l+s+s2}{The registered riders tend to ride on workingdays, and the casual riders tend to ride on }
         \PY{l+s+s2}{non\PYZhy{}workingdays.And on workingdays, the positive correlation is much weaker than that on }
         \PY{l+s+s2}{holidays or weekends. However, the slope corresponding to workday is larger than that }
         \PY{l+s+s2}{corresponding to non\PYZhy{}workday. }
         
         \PY{l+s+s2}{Overplotting makes it harder for us to see underlying trend. And in this case, scatters have}
         \PY{l+s+s2}{different colors given different condition. So overplotting make it more difficult to observe}
         \PY{l+s+s2}{complete trend or outliers considering overplotting may make some scatters and trend hidden. }
         \PY{l+s+s2}{Besides, overplotting make the density and distribution of scatters unclear.}
         \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
The relationship between casual and registered riders is likely to be positively related. 
The registered riders tend to ride on workingdays, and the casual riders tend to ride on 
non-workingdays.And on workingdays, the positive correlation is much weaker than that on 
holidays or weekends. However, the slope corresponding to workday is larger than that 
corresponding to non-workday. 

Overplotting makes it harder for us to see underlying trend. And in this case, scatters have
different colors given different condition. So overplotting make it more difficult to observe
complete trend or outliers considering overplotting may make some scatters and trend hidden. 
Besides, overplotting make the density and distribution of scatters unclear.
...
{\color{incolor}In [{\color{incolor}20}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{patches} \PY{k}{as} \PY{n+nn}{mpatches}  \PY{c+c1}{\PYZsh{} see the tutorial for how we use mpatches to generate this figure!}
         ...
         \PY{n}{ax1} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{kdeplot}\PY{p}{(}\PY{n}{casual\PYZus{}weekday}\PY{p}{,}\PY{n}{registered\PYZus{}weekday}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Reds}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{ax2} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{kdeplot}\PY{p}{(}\PY{n}{casual\PYZus{}weekend}\PY{p}{,}\PY{n}{registered\PYZus{}weekend}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Blues}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} <matplotlib.legend.Legend at 0x7fbc73727748>
\end{Verbatim}
...
plot you created for 2c? Why?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{q3b} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{The contour plot suggests that the relationship between casual and registered riders is }
         \PY{l+s+s2}{positive. And for non\PYZhy{}workday, the positive correlation is more obvious and closer to }
         \PY{l+s+s2}{linear. However, the scope of positive correlation is larger at workday than that at }
         \PY{l+s+s2}{non\PYZhy{}workday, which means that given number of casual riders is equal, the number of }
         \PY{l+s+s2}{registered riders of workday is likely to be larger than that of non\PYZhy{}workday considering }
         \PY{l+s+s2}{the x\PYZhy{}intercept and y\PYZhy{}intercept are almost the same. Besides, workday has the largest }
         \PY{l+s+s2}{density at (800, 4000), and non\PYZhy{}workday has the largest density at position (1500,3000).}
         
         \PY{l+s+s2}{Of course it}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{s easier to see the relationship on this contour plot. Because there is no }
         \PY{l+s+s2}{overplotting on this counter plot and we can see the density and distribution through }
         \PY{l+s+s2}{counter line. Besides, the relationship and trend are easier to figure out through line.}
         \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
The contour plot suggests that the relationship between casual and registered riders is 
positive. And for non-workday, the positive correlation is more obvious and closer to 
linear. However, the scope of positive correlation is larger at workday than that at 
non-workday, which means that given number of casual riders is equal, the number of 
registered riders of workday is likely to be larger than that of non-workday considering 
the x-intercept and y-intercept are almost the same. Besides, workday has the largest 
density at (800, 4000), and non-workday has the largest density at position (1500,3000).

Of course it's easier to see the relationship on this contour plot. Because there is no 
overplotting on this counter plot and we can see the density and distribution through 
counter line. Besides, the relationship and trend are easier to figure out through line.
...
if your title overlaps with your plot
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{ax} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{jointplot}\PY{p}{(}\PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{daily\PYZus{}counts}\PY{p}{,} \PY{n}{kind}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{kde}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\texttt{sns.lineplot}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} Method I: put all needed data into a single dataframe}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)}\PY{p}{)}
         \PY{n}{ax} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{)} \PY{o}{\PYZam{}} 
             \PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mnth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{]}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{set\PYZus{}index}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Day of the Month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of Riders}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Count of Casual vs Registered Riders by Day}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}23}]:} Text(0.5,1,'Count of Casual vs Registered Riders by Day')
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{}Method II: call \PYZsq{}lineplot\PYZsq{} with respect to \PYZsq{}casual\PYZsq{} and \PYZsq{}registered\PYZsq{} respectively}
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)}\PY{p}{)}
         \PY{n}{ax1} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{data}\PY{o}{=}\PY{n}{bike}\PY{p}{[}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mnth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{]}\PY{p}{,}
                           \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{ax2} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{data}\PY{o}{=}\PY{n}{bike}\PY{p}{[}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{yr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mnth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{]}\PY{p}{,}
                           \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{n}{q4b} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{On weekends, the number of casual riders is larger than usual and the number of registered }
         \PY{l+s+s2}{riders is smaller than usual. On the contrary, on weekdays, the number of casual riders is }
         \PY{l+s+s2}{smaller and the number of registered riders is larger. As a result, the difference value }
         \PY{l+s+s2}{between two lines has a weekly cycle that is large on weekdays and small on weekends.}
         
         \PY{l+s+s2}{First Reason: Registered riders have much larger cardinal number, so they are more likely to}
         \PY{l+s+s2}{have larger volatility among different months.}
         \PY{l+s+s2}{Second Reason: Holidays should be taken into account as well. Because most registered riders}
         \PY{l+s+s2}{use sharing bike to commute between home and work and holidays are always during a time period}
         \PY{l+s+s2}{in several specific months, which leads to larger volatility among different months.}
         \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
On weekends, the number of casual riders is larger than usual and the number of registered 
riders is smaller than usual. On the contrary, on weekdays, the number of casual riders is 
smaller and the number of registered riders is larger. As a result, the difference value 
between two lines has a weekly cycle that is large on weekdays and small on weekends.

First Reason: Registered riders have much larger cardinal number, so they are more likely to
have larger volatility among different months.
Second Reason: Holidays should be taken into account as well. Because most registered riders
use sharing bike to commute between home and work and holidays are always during a time period
in several specific months, which leads to larger volatility among different months.
...
Your plot should look like the following:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} set \PYZsq{}ci=None\PYZsq{} to remove the confidence interval by skipping bootstrapping.}
         \PY{n}{ax1} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{bike}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{ci}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}
         \PY{n}{ax2} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{bike}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{ci}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average Count of Casual vs Registered Riders by Hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{top}\PY{o}{=}\PY{l+m+mf}{0.94}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{q5b} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{There are two obvious peaks in the registered riders}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{ distribution. It may be the result of }
         \PY{l+s+s2}{morning peak and evening peak of traffic because people always go to work at around 8 o}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{clock}
         \PY{l+s+s2}{and go home from work at around 17\PYZhy{}18 o}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{clock.}
         
         \PY{l+s+s2}{As for casual riders, the number slowly rises to its peak during 5\PYZhy{}15 o}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{clock and then decreases}
         \PY{l+s+s2}{gradually.}
         \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
There are two obvious peaks in the registered riders' distribution. It may be the result of 
morning peak and evening peak of traffic because people always go to work at around 8 o'clock
and go home from work at around 17-18 o'clock.

As for casual riders, the number slowly rises to its peak during 5-15 o'clock and then decreases
gradually.
...
{\color{incolor}In [{\color{incolor}33}]:} \PY{k+kn}{from} \PY{n+nn}{statsmodels}\PY{n+nn}{.}\PY{n+nn}{nonparametric}\PY{n+nn}{.}\PY{n+nn}{smoothers\PYZus{}lowess} \PY{k}{import} \PY{n}{lowess}
         ...
         \PY{n}{days}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mon}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fri}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ftemp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{temp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{41}\PY{o}{*}\PY{l+m+mf}{1.8}\PY{o}{+}\PY{l+m+mi}{32} 
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{7}\PY{p}{)}\PY{p}{:}
             \PY{n}{yobs} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{weekday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{n}{days}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{prop\PYZus{}casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{n}{xobs} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{n}{bike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{weekday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{n}{days}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ftemp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{n}{ysmooth} \PY{o}{=} \PY{n}{lowess}\PY{p}{(}\PY{n}{yobs}\PY{p}{,} \PY{n}{xobs}\PY{p}{,} \PY{n}{return\PYZus{}sorted}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
             \PY{n}{ax} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{xobs}\PY{p}{,} \PY{n}{ysmooth}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{n}{days}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}34}]:} \PY{n}{q6c} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{The casual rider proportion increases when temperature goes up on both weekends and}
         \PY{l+s+s2}{weekdays. And when the temperature is above 40 degrees Fahrenheit, the casual rider}
         \PY{l+s+s2}{proportion of weekends is always larger than that of weekdays.}
         
         \PY{l+s+s2}{I notice that turning point is around 65 degrees Fahrenheit. The slope of lineplot }
         \PY{l+s+s2}{always change at a turning point in range from 60 to 70 degrees Fahrenheit. On weekends,}
         \PY{l+s+s2}{the rates of increasing slows down after the turning point. However, most of rates of}
         \PY{l+s+s2}{increasing on weekdays rise after the turning point except Friday, which is close to }
         \PY{l+s+s2}{weekends actually.}
         \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
The casual rider proportion increases when temperature goes up on both weekends and
weekdays. And when the temperature is above 40 degrees Fahrenheit, the casual rider
proportion of weekends is always larger than that of weekdays.

I notice that turning point is around 65 degrees Fahrenheit. The slope of lineplot 
always change at a turning point in range from 60 to 70 degrees Fahrenheit. On weekends,
the rates of increasing slows down after the turning point. However, most of rates of
increasing on weekdays rise after the turning point except Friday, which is close to 
weekends actually.
